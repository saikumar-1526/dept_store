...
def index():
    ...
    return render_template('admin/dashboard.html', departments = departments,
                           categories = categories, items = items, orders = orders, payments = payments)
...
def add_category():
    ...
    return render_template('admin/add_category.html', departments = departments)
...
def add_item():
    ...
    return render_template('admin/add_item.html', departments = departments)
...
def view_items():
    ...
    return render_template('admin/view_items.html', items = items)
...
def add_promocode():
    ...
    return render_template('admin/add_promocode.html')

@admin_bp.route('/promocodes/')
@login_required
def view_promocodes():
    codes = PromoCode.query.all()
    return render_template('admin/view_promocodes.html', codes = codes)
